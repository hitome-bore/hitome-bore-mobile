...
<?php if(have_posts()): ?>
  ...
  <?php endwhile; ?>
	...
	<div id="profile">
		<div id="wrapper">
			<div id="thumb">
				<img src="./img/lisa_dragon_ga_demo/template1-210x139.jpg" alt="profile-thumb">
			</div>
			<div id="info">
				<dl>
...
?>
					<dt>店舗URL</dt>
					<dd><a href="<?php echo $shopUrl; ?>"><?php echo $shopUrl; ?></a></dd>
<?php endif; ?>
...
<h1><i>Collabo infomation</i><?php the_title(); ?></h1>
