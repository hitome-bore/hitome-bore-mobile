<?php $model = get_posts('post_type=model&post_status=publish&posts_per_page=9&orderby=date&order=DESC'); ?>
<section class="archive">
<h1 class="title"><i>New model</i>最新のモデル</h1>
<?php $count = 1; foreach($model as $post): start_wp(); ?>
